...
public class DroidCardsActivity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        Droid[] droids = {
                new Droid("Joanna", R.color.joanna_color, R.drawable.alex),
                new Droid("Shailen", R.color.shailen_color, R.drawable.claire),
                new Droid("Chris", R.color.chris_color, R.drawable.kathryn)
        };
